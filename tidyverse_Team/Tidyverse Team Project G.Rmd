...
__Table 1. The summary of students' read test scores for the ses__ 
```{r echo=FALSE} 
...
# Create table 
Read_summary_table <- rbind(Read_summary[[1]],  
                            Read_summary[[2]],  
                            Read_summary[[3]]) 
...
col_names <- c("Min", "1st Qu", "Median",  
               "Mean", "3rd Qu", "Max",  
               "SD", "n") 
rownames(Read_summary_table) <- row_names 
colnames(Read_summary_table) <- col_names 
 
Read_summary_table 
``` 
__Figure 1. The boxplot for the read scores for different ses__ 
```{r echo=FALSE} 
read_boxplot <- boxplot(hsb2_data$read ~ hsb2_data$ses, 
         main = "Reading Scores by SES", 
         xlab = "SES", 
         ylab = "Reading Score", 
         col = "lightblue", 
         data = hsb2_data, 
