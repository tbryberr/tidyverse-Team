...
See Figure 1 for the boxplot we used to check for homogeneity of variance visually. Boxplots show us the distribution of the data and the variance of the data for each group. If the variances are all equal across groups, shapes and sizes of the box plots will be similar. On the contrary, if the variances are not equal, the boxplots will have different shapes and sizes. Based on the box plot, we can suggest that this data does not have homogeneity of variances. 
